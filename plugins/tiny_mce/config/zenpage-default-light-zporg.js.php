 ...
 */ 
?>
	<script language="javascript" type="text/javascript" src="<?php echo FULLWEBPATH.'/'.ZENFOLDER.'/'.PLUGIN_FOLDER; ?>/tiny_mce/tiny_mce.js"></script>
	<script language="javascript" type="text/javascript">
		...
		tinyMCE.init({
			...
			theme_advanced_buttons2 : "undo,redo,|,link,unlink,anchor,image,cleanup,removeformat,help,code,fullscreen,hr,|,pagebreak,tinyzenpage",
