...
function processFilters() {
	require_once(SERVERPATH.'/'.ZENFOLDER.'/setup/class-setup.php');
	require_once(SERVERPATH.'/'.ZENFOLDER.'/setup/class-setupmutex.php');
	...
	setup::getResidentZPFiles(SERVERPATH.'/'.ZENFOLDER);
	setup::getResidentZPFiles(SERVERPATH.'/'.THEMEFOLDER);
