...
if (!defined('NEWS_POSITION_NORMAL')) define('NEWS_POSITION_NORMAL',0);
if (!defined('NEWS_POSITION_STICK_TO_TOP')) define('NEWS_POSITION_STICK_TO_TOP',9);
	...
	function getOptionsSupported() {
		...
		$options = array(	gettext('Add release') => array('key' => 'releaseList_current', 'type' => OPTION_TYPE_TEXTBOX,
											...
											gettext('News text') => array('key' => 'releaseList_text', 'type' => OPTION_TYPE_TEXTAREA,
												'order'=>1,
												'desc' => gettext('Enter the text to be used for the release article.'))
		);
		return $options;
	}
