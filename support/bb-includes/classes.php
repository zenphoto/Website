...
class BB_Walker {
	...
	//abstract callbacks
	function start_lvl($output, $depth=NULL) { return $output; }
	function end_lvl($output, $depth=NULL)   { return $output; }
	function start_el($output=NULL, $forum=NULL, $depth=NULL)  { return $output; }
	function end_el($output=NULL, $forum=NULL, $depth=NULL)    { return $output; }
...
class BB_Walker_Blank extends BB_Walker { // Used for template functions
	...
	//abstract callbacks
	function start_lvl( $output, $depth=NULL ) {
		if ( !$this->start_lvl )
			return '';
	...
	function end_lvl( $output, $depth=NULL )   {
		if ( !$this->end_lvl )
			return '';
		$indent = str_repeat("\t", $depth);
	...
	function start_el($output=NULL, $forum=NULL, $depth=NULL)  { return ''; }
	function end_el($output=NULL, $forum=NULL, $depth=NULL)    { return ''; }
}
