<?php
/**
 * Plugin Name: RSS Extractor and Displayer
 * Plugin Description: (c) 2007-2009  Scriptol.com - License Mozilla 1.1.
 * Author: Scriptol.com
 * Author URI: http://Scriptol.com
 * Plugin URI: http://Scriptol.com
 * Version: 1.0
 */
...
function RSS_Display($url, $size = 15, $site = 0) {
	...
	foreach($recents as $article) {
		...
		$date = strftime("%D",strtotime($article["pubDate"]));
		$link = $article["link"];
		$description = $article["description"];
		$page .= "<li><a href=\"$link\"><strong>$title</strong> <small>($date)</small></a>";
